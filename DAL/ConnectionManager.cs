...
namespace DAL
{
    ...
    {
        //private const string CONNECTION_STRING = @"Data Source=DESKTOP-8BR9SMI\SQLEXPRESS;Initial Catalog=Manager;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        private const string CONNECTION_STRING = @"Data Source=DESKTOP-1O3GVND\SQLEXPRESS;Initial Catalog=ManagerOfProduct;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
